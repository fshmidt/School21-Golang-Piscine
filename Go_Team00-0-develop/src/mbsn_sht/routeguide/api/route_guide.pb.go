...
func (x *Mes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Mes) ProtoMessage() {}

func (x *Mes) ProtoReflect() protoreflect.Message {
	mi := &file_route_guide_proto_msgTypes[0]
...
// Deprecated: Use Mes.ProtoReflect.Descriptor instead.
...
func (x *Messages) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *Messages) GetFrequency() float64 {
	if x != nil {
		return x.Frequency
	}
	return 0
...
func (x *Messages) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_route_guide_proto_rawDesc = []byte{
	...
	0x05, 0x0a, 0x03, 0x4d, 0x65, 0x73, 0x22, 0x65, 0x0a, 0x08, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	0x28, 0x04, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0x47, 0x0a,
	0x0a, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x47, 0x75, 0x69, 0x64, 0x65, 0x12, 0x39, 0x0a, 0x0c, 0x4c,
	0x69, 0x73, 0x74, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x12, 0x0f, 0x2e, 0x72, 0x6f,
	0x75, 0x74, 0x65, 0x67, 0x75, 0x69, 0x64, 0x65, 0x2e, 0x4d, 0x65, 0x73, 0x1a, 0x14, 0x2e, 0x72,
	0x6f, 0x75, 0x74, 0x65, 0x67, 0x75, 0x69, 0x64, 0x65, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x73, 0x22, 0x00, 0x30, 0x01, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x61, 0x70, 0x69, 0x62,
...
var file_route_guide_proto_goTypes = []interface{}{
	(*Mes)(nil),      // 0: routeguide.Mes
	(*Messages)(nil), // 1: routeguide.Messages
}
var file_route_guide_proto_depIdxs = []int32{
	0, // 0: routeguide.RouteGuide.ListFeatures:input_type -> routeguide.Mes
	1, // 1: routeguide.RouteGuide.ListFeatures:output_type -> routeguide.Messages
